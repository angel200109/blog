...
export const defaultSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "valueOf 方法详解", link: "/basics/js-valueof" },
      { text: "JS 堆栈内存与参数传递", link: "/basics/js-memory-storage" },
      { text: "原型链实现继承", link: "/basics/prototype-inheritance" },
      { text: "JavaScript 作用域链", link: "/basics/js-scope-chain" },
      { text: "JavaScript 闭包", link: "/basics/js-closure" },
      ...
      { text: "TS 类型推断与类型注释", link: "/typescript/type-inference-vs-annotation" },
      { text: "TS 交叉类型与联合类型", link: "/typescript/intersection-vs-union" },
      { text: "TS 类型断言", link: "/typescript/type-assertion" },
    ],
  },
  {
    text: "前端工程化",
